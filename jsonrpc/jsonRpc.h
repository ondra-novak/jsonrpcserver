...
public:
	...
	///Enables handling of "null" origin.
	/** This origin appears in requests generated by file:// access and otherwise
	  by access without known origin. You can disable CORS but allow null origin to
	  open the server to be accessible from the local file 
	  
	  Function enables to detect null Origin which causes that '*' is temporary put to "Access-Control-Allow-Origin"
	  */
	void allowNullOrigin(bool enable);


	///Determines whether null origin is allowed
	bool isNullOriginAllowed() const;
